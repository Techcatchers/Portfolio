...
const freelanceWork = data => {
  ...
  output += `
    ...
    <div class="col-md-4 col-sm-4">
      <img data-src="./images/photography.gif" alt="" class="img web-template">
    </div>
    <div class="col-md-4 col-sm-4">
      <img data-src="./images/login.jpg" alt="" class="img web-template">
    </div>
    <div class="col-md-4 col-sm-4">
      <img data-src="./images/PSDhtml.gif" alt="" class="img web-template">
    </div>
